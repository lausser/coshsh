...
class SimpleSample(Datasource):
    ...
    def read(self, filter=None, objects={}, **kwargs):
        ...
        self.get('applications', Application(appdata).fingerprint()).monitoring_details.append(MonitoringDetail(fsc))
        self.get('applications', Application(appdata).fingerprint()).monitoring_details.append(MonitoringDetail(fsd))
