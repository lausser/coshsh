"""Tests for os.environ variable expansion inside rendered Jinja2 templates."""
...
class ExtensionsTest(CommonCoshshTest):

    def test_osenviron(self):
        """Verify that os.environ values are expanded in templates, including defaults and live updates."""
