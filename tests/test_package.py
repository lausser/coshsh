...
class CoshshTest(CommonCoshshTest):
    ...
    def test_create_contact(self):
        contact = Contact({"type": "WEBREADONLY", "name": "sepp", "userid": "test", "notification_period": "5x8"})
