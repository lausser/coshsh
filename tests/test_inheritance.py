...
class CoshshTest(unittest.TestCase):
    ...
    def test_inheritance(self):
        ...
        self.assert_(self.generator.recipes['cust'].datasource_filters['csv10.1'] == 'fff')
        self.assert_(self.generator.recipes['cust1'].datasource_names == ['csv10.1', 'csv10.2', 'csv10.3'])
        self.assert_(self.generator.recipes['cust1'].datasource_filters['csv10.1'] == 'fff1')
        #self.assert_(self.generator.recipes['cust2'].datasource_names == ['csv10.1', 'csv10.2', 'csv10.3'])
        #self.assert_(self.generator.recipes['cust2'].datasource_filters['csv10.1'] == 'fff2')
        self.assert_(self.generator.recipes['cust3'].datasource_names == ['csv10.1', 'csv10.2', 'csv10.3'])
        self.assert_(self.generator.recipes['cust3'].datasource_filters['csv10.1'] == 'fff3')
