...
from coshsh.util import odict, setup_logging
...
class CoshshTest(unittest.TestCase):
    ...
    def test_growing_hosts(self):
        ...
        self.assertTrue(hasattr(self.generator.recipes['test15'].objects['hosts']['test_host_000'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test15'].objects['hosts']['test_host_000'].config_files['nagios'])
        self.assertTrue(hasattr(self.generator.recipes['test15'].objects['hosts']['test_host_009'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test15'].objects['hosts']['test_host_009'].config_files['nagios'])
        ...
        self.assertTrue(hasattr(self.generator.recipes['test15'].objects['hosts']['test_host_010'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test15'].objects['hosts']['test_host_010'].config_files['nagios'])
        self.assertTrue(hasattr(self.generator.recipes['test15'].objects['hosts']['test_host_019'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test15'].objects['hosts']['test_host_019'].config_files['nagios'])
    ...
    def test_grow_grow_ok(self):
        ...
        self.assertTrue(hasattr(self.generator.recipes['test16'].objects['hosts']['test_host_000'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test16'].objects['hosts']['test_host_000'].config_files['nagios'])
        self.assertTrue(hasattr(self.generator.recipes['test16'].objects['hosts']['test_host_009'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test16'].objects['hosts']['test_host_009'].config_files['nagios'])
        ...
        self.assertTrue(hasattr(self.generator.recipes['test16'].objects['hosts']['test_host_010'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test16'].objects['hosts']['test_host_010'].config_files['nagios'])
        self.assertTrue(hasattr(self.generator.recipes['test16'].objects['hosts']['test_host_019'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test16'].objects['hosts']['test_host_019'].config_files['nagios'])
    ...
    def test_shrinking_hosts(self):
        ...
        self.assertTrue(hasattr(self.generator.recipes['test16'].objects['hosts']['test_host_000'], 'config_files'))
        self.assertTrue('host.cfg' in self.generator.recipes['test16'].objects['hosts']['test_host_000'].config_files['nagios'])
        self.assertTrue('test_host_001' in self.generator.recipes['test16'].objects['hosts'])
        self.assertTrue('test_host_002' not in self.generator.recipes['test16'].objects['hosts'])
